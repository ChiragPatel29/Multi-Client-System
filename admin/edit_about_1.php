              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <?php
					...
					$q1=mysqli_query($link,"select * from about where id = '".$id."'");
					...
					<div class="x_content" >
                    <br/>
					<form name="myform" method="post" action="edit_about.php" class="form-horizontal form-label-left">
					
					 <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Title
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="title" value="<?php echo $res['title']; ?> " name="title" class="form-control col-md-7 col-xs-12">
              </div>
                        </div>
                      <div class="form-group">
